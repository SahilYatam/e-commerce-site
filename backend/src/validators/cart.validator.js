...
const decreaseQuantitySchema = Joi.object({ userId: userIdField, productId: productIdField, quantity: quantityField });

const removeFromCartSchema = Joi.object({ userId: userIdField, productId: productIdField });
